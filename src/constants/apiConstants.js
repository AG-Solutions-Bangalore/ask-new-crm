...
export const PANEL_CHECK = {
  ...
  getEnvStatus: "/web-check-status", // Using same as secondary check or we might need to disable env check if not supported
};
...
export const WEB_API = {
  checkStatus: "/web-check-status",
  login: "/web-login",
  checkMobileNo: "/web-check-mobile-no",
  registerOtp: "/web-registerotp",
  insertRegister: "/web-insert-register",
  fetchState: "/fetch-web-state",
  fetchGotra: "/fetch-web-gotra",
  fetchFamilyMember: "/fetch-web-family-member",
  fetchFamilyMemberView: (id) => `/fetch-web-family-member-view/${id}`,
  fetchPatronMembers: "/fetch-web-patron-members",
  fetchLifeTimeMembers: "/fetch-web-life-time-members",
  fetchNewRegisters: "/fetch-web-new-registers",
  fetchPendingMid: "/fetch-web-pending-mid",
  updateRegisterAdmin: (id) => `/update-web-register-admin/${id}`,
  downloadSummaryReport: "/download-summary-report",
  downloadFullReport: "/download-full-report",
  fetchProfile: "/fetch-web-register-user-edit",
  updateProfile: "/update-web-register?_method=PUT",
  fetchFamilyMemberData: (id) => `/fetch-web-family-member-data/${id}`,
  updateFamilyMember: (id) => `/update-web-family-member/${id}`,
  createFamilyMember: "/create-web-family-member",
  fetchLifeTimeMember: "/fetch-web-life-time-members",
  fetchPatronMember: "/fetch-web-patron-members",
  fetchNewRegister: "/fetch-web-new-register",
  fetchMemberView: (id) => `/fetch-web-family-member-view/${id}`,
  updateMemberAdmin: (id) => `/update-web-register-admin/${id}?_method=PUT`,
  fetchMemberData: (id) => `/fetch-web-member-data/${id}`,
  updateMid: (id) => `/update-web-mid/${id}`,
  fetchPendingMid: "/fetch-web-pending-mid",
  fetchMahilaEvents: "/fetch-web-events/mahila",
  fetchSamajEvents: "/fetch-web-events/samaj",
};
