      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        <div className="flex items-center gap-4">
          <div className="p-3 bg-pink-50 rounded-xl">
            <FiUsers className="w-6 h-6 text-pink-700" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-slate-900">Family Members</h1>
            <p className="text-sm text-slate-500">Manage your family member details and relations.</p>
          </div>
        </div>
        <Link to="/add-family-member">
          <Button className="bg-pink-700 hover:bg-pink-800 text-white flex gap-2 rounded-xl h-11 px-6 shadow-lg shadow-pink-100 transition-all active:scale-95">
            <FiPlus /> Add Member
          </Button>
        </Link>
      </div>
