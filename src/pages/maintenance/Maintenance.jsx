...
const Maintenance = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-8 text-center animate-in fade-in duration-700">
            <div className="w-24 h-24 bg-pink-100 rounded-full flex items-center justify-center text-pink-700 mb-8 border-4 border-pink-200">
            ...
            <div className="flex flex-col gap-4 w-full max-w-xs">
                <Button 
                    className="bg-pink-700 hover:bg-pink-800 text-white h-12 rounded-xl shadow-lg shadow-pink-100"
                    onClick={() => navigate("/")}
                >
                    Try Refreshing
                </Button>
