  ...
  return (
    <div className="container mx-auto p-4 md:p-8 space-y-8 mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <Card className="overflow-hidden rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all">
          <CardHeader className="bg-slate-50/50 border-b border-slate-100 pb-6">
            ...
            <CardDescription>
              A high-level summary of all registered members, including basic member counts and status.
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            ...
            >
              {downloadingSummary ? <Loader2 className="h-5 w-5 animate-spin" /> : <FiDownload className="h-4 w-4" />}
        ...
        <Card className="overflow-hidden rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all">
          ...
          <CardContent className="pt-6">
            ...
            >
              {downloadingFull ? <Loader2 className="h-5 w-5 animate-spin" /> : <FiDownload className="h-4 w-4" />}
