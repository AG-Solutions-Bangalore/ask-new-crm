//-------------------System & Status------------------------//
export const CHECK_STATUS_API = `/web-check-status`;
export const FETCH_DOTENV_API = `/web-check-status`; // CRM doesn't have dotenv status, so we reuse the status check
...
//-------------------User------------------------//
export const USER_LIST_API = `/user`;
export const USER_BY_ID_API = (id) => `/user/${id}`;
